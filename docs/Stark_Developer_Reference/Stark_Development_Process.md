...
-   Check out the code base: [http://luxgit.mlp.com/algo-execsvcs/stark](http://luxgit.mlp.com/algo-execsvcs/stark)
...
-   [https://jira.mlp.com/projects/AX/summary](https://jira.mlp.com/projects/AX/summary)
